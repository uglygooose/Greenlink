#!/usr/bin/env python3
"""
Create Andrew admin user in database with proper bcrypt hash
"""
...
# Configuration
ADMIN_EMAIL = "andrew@greenlink.com"
ADMIN_NAME = "Andrew"
ADMIN_PASSWORD = "Andrew"
...
try:
    conn = mysql.connector.connect(
        host="localhost",
        user="root",
        password="okhe@2024",  # Change if you have MySQL password
        database="greenlink"
    )
