...
- `/admin/tee-sheet` → `frontend/src/pages/admin-tee-sheet-page.tsx` (Phase 10 rebuild — Slices 1–11; Slice 12 tournament mode deferred to Phase 11 per DRIFT_LOG 2026-05-14).
