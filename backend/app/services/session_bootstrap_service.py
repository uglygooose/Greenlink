...
MENU_ITEMS: tuple[dict[str, str | None], ...] = (
    ...
    {"key": "golf_settings", "label": "Settings", "path": "/admin/golf/settings", "shell": "admin", "domain": "golf", "module_key": "golf"},
    ...
    {"key": "club_settings", "label": "Club Settings", "path": "/admin/settings/club", "shell": "admin", "domain": "settings", "module_key": None},
