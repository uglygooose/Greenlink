"""Phase 9D WI-6 / WI-13 — KPI metrics + member-stats read model.
...
from app.services.people_read_model_service import (
    ActivityWindow,
    PeopleReadModelService,
)
...
# ---------- WI-13 PeopleReadModelService tests ----------------------------
